...
export default function Map() {
  const bulanCordinates = [12.6538317, 123.8302827];
  const markerLoc1 = [12.6538317, 123.8302827];
  const markerLoc2 = [12.4749836,123.8624448];
  const markerLoc3 = [12.6572772,123.7621945];
  const markerLoc4 = [12.5465033,124.0872601];
  return (
    <React.Fragment>
      <CssBaseline>
        <Container maxWidth={false} sx={{ bgcolor: "#fff" }}>
          <Box sx={{ textAlign: "center", paddingTop: 2, paddingBottom: 2 }}>
            <Typography variant="h5">Tamban Location Map</Typography>
          </Box>
          <Box>
            <MapContainer
              center={bulanCordinates}
              zoom={10}
              scrollWheelZoom={false}
              style={{ height: "80dvh", width: "95dvw" }}
            >
              <TileLayer
              ...
              />
              <MarkerLayer>
              <Marker position={markerLoc1}>
                  {/* <div>Bulan Sorsogon</div> */}
                  <SvgIcon>
                    <svg
                      fill="#E74C3C"
                      height="800px"
          ...
          <Box sx={{ textAlign: "left", paddingTop: 2, paddingBottom: 2, fontSize:10, color:"red" }}>
            TODOs:
            <ul>
                <li>Enhance UI</li>
                <li>Enhance markers</li>
                <li>Create user input controls</li>
            </ul>
          </Box>
        </Container>
      </CssBaseline>
